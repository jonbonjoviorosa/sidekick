    ...
    class Program
    {
        ...
        public static async Task CallAllBookingBeforeAppointment(string BaseUrl)
        {
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage clientResponse = await client.GetAsync("api/Booking/AllBookingBefore48HoursSetTimeOfAppointment");
        ...
        {
            await client.GetAsync($"api/Booking/Individual/PaymentAuthProcess/{bookingId}");
        }
